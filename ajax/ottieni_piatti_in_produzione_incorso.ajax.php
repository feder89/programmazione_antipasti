<?php
	...
	if($date <=0){
		...
		$idprg=0;
		$idprg_next=0;
		$query_idprog="SELECT min(idprogrammazione) as idprg FROM programmazioneordini WHERE stato = 2 AND serata='$date' AND categoria IN ('antipasto','bruschette e crostoni','dolce')";
